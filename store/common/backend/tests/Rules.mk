...
$(d)thread_safe_kvs_test: \
	$(o)thread_safe_kvs_test.o \
	$(LIB-message) $(LIB-store-common) $(LIB-store-backend) $(GTEST_MAIN)

TEST_BINS += $(d)thread_safe_kvs_test
